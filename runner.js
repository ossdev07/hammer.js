...
const { runQunitPuppeteer, printOutput } = require('./node_modules/node-qunit-puppeteer/index');
...
const qunitArgs = {
  ...
  puppeteerArgs: ['--allow-file-access-from-files', '--no-sandbox', '--headless', '--disable-gpu'],
};

Console.log(`Target URL is ${qunitArgs.targetUrl}, timeout is ${qunitArgs.timeout}, path is ${qunitArgs.executablePath}`);
